      ...
      <div className="container">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <h2 className="heading">Projects with cinematic depth</h2>
            <p className="subheading">Immersive product work, resilient platforms, and refined interfaces.</p>
          </div>
          ...
          >
            <TiltCard className="glass-panel relative overflow-hidden rounded-3xl p-10" maxTilt={10}>
              ...
              <div className="relative z-10 space-y-6">
                ...
                <h3 className="text-2xl font-semibold text-white">Cinematic product dashboard</h3>
                <p className="text-slate-300">
                  A layered device mockup with depth, cursor-tracked lighting, and dynamic shadowing to bring the
                  product story to life.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  {['Interface systems', 'Realtime data', 'Motion design', 'Performance'].map((item) => (
            ...
            <div className="space-y-4">
              <div className="glass-panel rounded-2xl p-6">
                ...
                <p className="mt-4 text-lg text-white">High-impact product storytelling through motion and restraint.</p>
              </div>
              <div className="glass-panel rounded-2xl p-6">
                <p className="eyebrow">Outcome</p>
                <p className="mt-4 text-sm text-slate-300">Premium user perception, measurable engagement, and a durable UI system.</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-6">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-semibold text-white">Additional builds & experiments</h3>
              </div>
